...
!-----------------------------------------------------------------------
    ...
    !
        ...
        MODULE PROCEDURE assign_rpe_complex_alternate_complex
        MODULE PROCEDURE assign_real_complex_rpe_complex
        MODULE PROCEDURE assign_alternate_complex_rpe_complex
    END INTERFACE
...
!-----------------------------------------------------------------------
    ...
    !       An `rpe_complex_type` instance to assign to.
    !
    ! * x: complex(kind=RPE_ALTERNATE_KIND) [input]
    !       A real complex variable whose value will be assigned to `rpe`.
    !
        TYPE(rpe_complex_var),            INTENT(INOUT) :: rpe
    ...
    ! Assign an `rpe_complex_type` instance to a real complex variable.
    !
    ! Arguments:
    !
    ! * x: complex(kind=RPE_REAL_KIND) [input/output]
    !       A real complex variable assign to.
    !
    ! * rpe: class(rpe_complex_type) [input]
    !       An `rpe_complex_type` instance whose value will be assigned to `x`.
    !
        COMPLEX(KIND=RPE_REAL_KIND), INTENT(INOUT) :: x
        TYPE(rpe_complex_var),       INTENT(IN)    :: rpe
        x = rpe%val
    END SUBROUTINE assign_real_complex_rpe_complex

    ELEMENTAL SUBROUTINE assign_alternate_complex_rpe_complex (x, rpe)
    ! Assign an `rpe_complex_type` instance to a real complex variable.
    !
    ! Arguments:
    !
    ! * x: complex(kind=RPE_ALTERNATE_KIND) [input/output]
    !       A real complex variable assign to.
    !
    ! * rpe: class(rpe_complex_type) [input]
    !       An `rpe_complex_type` instance whose value will be assigned to `x`.
    !
        COMPLEX(KIND=RPE_ALTERNATE_KIND), INTENT(INOUT) :: x
        TYPE(rpe_complex_var),            INTENT(IN)    :: rpe
        x = rpe%val
    END SUBROUTINE assign_alternate_complex_rpe_complex
